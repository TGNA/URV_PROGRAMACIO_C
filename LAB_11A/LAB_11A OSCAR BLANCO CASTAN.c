...
int main(){
    ...
    while(!continua){
        ...
        scanf("%d", &menu);
        switch(menu){
            case 0: printf("\nIntrodueixi una temperatura: ");
                    scanf("%d", &temperaturaAgost);
                    agost(temperaturaAgost, 8-1, temperatures);
                    break;
            case 1: printf("\nIntrodueixi una temperatura: ");
                    scanf("%d", &temperatura);
                    hivern(temperatures, temperatura);
                    break;
            case 2: temperatura_baixa(temperatures);
                    break;
        }
